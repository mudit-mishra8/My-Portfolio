...
|🎶[Spotify Data Pipeline with AWS](https://github.com/mudit-mishra8/ETL-Spotify/blob/main/README.md) | Spotify API, Lambda, Amazon S3, Athena, Event Bridge, AWS Glue, Python |This data engineering project, hosted on AWS, seamlessly orchestrates the daily extraction of global playlist data from Spotify's API. It employs AWS Lambda functions for data extraction and for data transformation, and then stores the structured data in S3 buckets. Also utilizing AWS Glue for data cataloging and Amazon Athena for querying the data.|
