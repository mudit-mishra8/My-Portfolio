...
|--------------|------|---------------------|
|🕷️ [Conversations Summarizer](https://github.com/mudit-mishra8/Conversation-Processing/blob/main/README.md) |Text Analytics|In my Conversation Analyzer project, I embarked on a journey to decode conversations with precision. Leveraging Python and Pandas, I meticulously cleaned and analyzed conversational data. By exploring speaker dynamics, speech duration, and word counts and lot more.|
