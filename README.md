...
|🕷️ [Zillow Zestimate](https://github.com/mudit-mishra8/Zillow/blob/main/README.md) |Web Scrapping & Linear Regression|In my three-part Zillow project, I first wield web scraping techniques to gather housing data. Next, I transform this raw data into a polished gem through cleaning, feature engineering, and crafting a linear regression model. Achieving a remarkable accuracy of 92%, this model predicts Zestimates with finesse. Finally, statistical analysis on the clean and transformwd to data to answer questions like, how Zestimates react to varying property features.|
