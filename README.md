...
Here is my latest application to explore trends in Olympics data! 👉 [Olympics Analyzer](https://olympics-analysis-by-mudit-app-d05d3c3a4d2c.herokuapp.com)   
...
5. [DATA VISUALIZATION: TABLEAU](#Tableau)
...
|🎵 [SPOTIFY DATA INSIGHTS](https://github.com/mudit-mishra8/Spotift-SQL-Case-Study/blob/main/README.md) | User Activity Analysis | In this project, we conducted a case study using MySQL queries to analyze user activity data for Spotify. By delving into crucial metrics such as installations, purchases, and conversion rates, our aim was to provide valuable insights that enable Spotify to make data-driven decisions.|
|📊[E-COMMERCE DATA ANALYSIS](https://github.com/mudit-mishra8/Ecommerce-Analysis/blob/main/README.md) | Sales & Product Analysis | This case study involved comprehensive analysis of an ecommerce platform, including traffic analysis, website performance analysis, conversion funnel evaluation, and product analysis. The project aimed to derive actionable insights for optimizing website traffic, enhancing performance, and maximizing conversions to drive business growth.|
...
|--------------|------|---------------------|
|🗣️ [Conversations Summarizer](https://github.com/mudit-mishra8/Conversation-Processing/blob/main/README.md) |Text Analytics|In this project, I embarked on a journey to decode conversations with precision. Leveraging Python and Pandas, I meticulously cleaned and analyzed conversational data.  This project simplifies the understanding of complex conversations, offering a comprehensive view of communication patterns and trends.|
|🏅 [Olympics Data Analysis](https://github.com/mudit-mishra8/olympic-app/blob/main/README.md) |right click to open app in a new tab 👉[ Olympics Analyzer](https://olympics-analysis-by-mudit-app-d05d3c3a4d2c.herokuapp.com) |This project provides an insightful analysis of historical Summer Olympics data. Through an interactive web application, users can explore trends, such as medal distributions and athlete performances. It serves as a comprehensive tool for understanding the impact and progression of the Summer Olympics over time.|
...
## Data Engineering
| Project Link | Language and Tools | Project Description |
|--------------|------|------------|
|⚙️[AWS ETL](https://github.com/mudit-mishra8/ETL-Glue-Basic/blob/main/README.md#Step-3-Create-Database-in-AWS-Lake-Formation) | PySpark, AWS Glue, Amazon S3, AWS Lake Formation, IAM, AWS Glue Crawlers, Jupyter Notebook | This project involves leveraging AWS Glue with PySpark to implement an ETL (Extract, Transform, Load) job, which extracts data from different sources stored in an AWS S3-based data lake, performs transformations, and then loads the result back into S3. The ETL process is automated and managed using AWS Glue Jobs and Glue Crawlers.|
|🎻[Spotify AWS Pipeline](https://github.com/mudit-mishra8/ETL-Spotify/blob/main/README.md) | Spotify API, Lambda, Amazon S3, Athena, Event Bridge, AWS Glue, Python | This data engineering project, hosted on AWS, seamlessly orchestrates the daily extraction of global playlist data from Spotify's API. It employs AWS Lambda functions for data extraction and for data transformation, and then stores the structured data in S3 buckets. Also utilizing AWS Glue for data cataloging and Amazon Athena for querying the data.|
|🚀[NASA Apod Serverless](https://github.com/mudit-mishra8/NASA-Daily/blob/main/README.md) | Java, Kafka, Python, NASA Apod Api, Lambda, Amazon S3, Event Bridge, DynamoDB, AWS SES| This is a implementation of a serverless architecture in AWS, which extracts, transform and load the NASA image data using Kafka, stores it in an S3 bucket, processes the data using multiple AWS Lambda functions, and then sends a daily email to registered users using SES.|
