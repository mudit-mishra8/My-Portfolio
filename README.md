...
|💡[E-COMMERCE DATA INSIGHTS](https://github.com/mudit-mishra8/Ecommerce-Analysis/blob/main/README.md) | Sales & Product Analysis | This case study involved comprehensive analysis of an ecommerce platform, including traffic analysis, website performance analysis, conversion funnel evaluation, and product analysis. The project aimed to derive actionable insights for optimizing website traffic, enhancing performance, and maximizing conversions to drive business growth.|
