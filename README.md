...
|--------------|------|---------------------|
|🕷️ [Imdb Top 250 ](https://github.com/mudit-mishra8/Imdb-web-scrapping/blob/main/README.md) |Web Scrapping | This project demonstrates adept web scraping skills by extracting vital information on IMDb's Top 250 movies. Utilizing Python, BeautifulSoup, and Pandas, it efficiently gathers data such as movie names, release dates, cast, directors, genres, and financials. This data collection is invaluable for analyzing trends and insights in the film industry.|
|🎞️ [Cinema](https://github.com/mudit-mishra8/python-imdb-data-analysis/blob/main/README.md) |Data Analytics| This project embodies the essence of data-driven storytelling through the lens of cinema. Using the scraped dataset of top 250 movies, the project utilizes Python and Pandas for data cleaning, feature engineering, and in-depth analysis. By unraveling interesting insights like genre preferences, director contributions, and movie budgets, it adds a significant value for movie enthusiasts and industry professionals.|
